...
namespace BuiltInMethods
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var citiesNew=cities.Distinct(); //distinct metodu list de bulunan verilerin tekrarlayan kayıtların tekrarlanmamasını sağlar.
            
            foreach (var item in citiesNew) // yeni olusturulan listeyi ekrana yazdırma
            {

...
namespace usingDelegate
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //.NET 2.0:
            var filtered2 = Filters.Filter(numbers, delegate (int c) { return c < 5; }); // metodu parametre olarak gönderiyoruz burada direk
            
            //.NET 3.5:
            var filtered3 = Filters.Filter(numbers, c => c % 5 == 0);// return demeye gerek yok burada 
            ...
            filtered3.ForEach(p => Console.WriteLine(p));
